...
/**
 * 
 * Title: EPPSuggestionConstants
 * 
 * Description: This interface defines constants to be used when processing the
 * language and key elements from the EPP Suggestion INFO command. It also 
 * includes constants which identify the expected values for the 
...
public interface EPPSuggestionConstants
{
    ...
    /**
     * English language Constant as represented in ISO 639-2/B Code used
     * with EPP
     */
    ...
    /**
     * Portuguese language Constant as represented in ISO 639-2/B Code
     * used with EPP
     */
    ...
    /**
     * German language Constant as represented in ISO 639-2/B Code used
     * with EPP
     */
    ...
    /**
     * French language Constant as represented in ISO 639-2/B Code used
     * with EPP
     */
