...
public class SuggestionHandler extends EPPSuggestionHandler {
	...
	protected EPPEventResponse doSuggestionInfo(EPPEvent aEvent, Object aData) {
		...
		if (theMessage.getKey().equalsIgnoreCase("RANDOMIZE")) {
			...
			try {
				...
				theTable.addRow(new EPPSuggestionRow("FOOTBALLTEAMUP.COM", (short) 670,
						StatusEnum.STATUS_AVAILABLE));
				theTable.addRow(new EPPSuggestionRow("TEAMTEAMUP.COM", (short) 670,
						StatusEnum.STATUS_AVAILABLE));
				...
				theTable.addRow(new EPPSuggestionRow("SOCCERTEAMS.CC", (short) 660,
						StatusEnum.STATUS_AVAILABLE));
				theTable.addRow(new EPPSuggestionRow("FREESOCCERTEAM.COM", (short) 650,
						StatusEnum.STATUS_AVAILABLE));
			} catch (InvalidValueException e) {
				e.printStackTrace();
			}
        ...
        System.out.println("theResponse.language = " + theResponse.getLanguage());
