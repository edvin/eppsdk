...
public class EPPDomainInfoCmd extends EPPInfoCmd {
	...
	// End EPPDomainInfoCmd.EPPDomainInfoCmd()
	...
	// End EPPDomainInfoCmd.EPPDomainInfoCmd(String, String)
	...
	public EPPDomainInfoCmd(String aTransId, String aName, EPPAuthInfo aAuthInfo) {
		...
		authInfo = aAuthInfo;
		authInfo.setRootName(EPPDomainMapFactory.ELM_DOMAIN_AUTHINFO);
	}
	...
	// End EPPDomainInfoCmd.getNamespace()
	...
	// End EPPDomainInfoCmd.setHosts(String)
	...
	// End EPPDomainInfoCmd.doEncode(Document)
	...
	protected void doDecode(Element aElement) throws EPPDecodeException {
		...
		// Host
		NodeList elm = aElement.getElementsByTagName(ELM_DOMAIN_NAME);

		if (elm.getLength() == 1) {
			this.hosts = ((Element) elm.item(0)).getAttribute(ATTR_HOSTS);
	...
	// End EPPDomainInfoCmd.doDecode(Node)
	...
	// End EPPDomainInfoCmd.setName(String)
	...
	// End EPPDomainInfoCmd.equals(Object)
