...
public class EPPDomainCheckResult implements EPPCodecComponent {
	...
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		if (reason != null) {
			Element reasonElm =
				aDocument.createElementNS(EPPCodec.NS, ELM_DOMAIN_REASON);
	...
	public void decode(Element aElement) throws EPPDecodeException {
		// Available
		Element theNameElm =
			EPPUtil.getElementByTagName(aElement, ELM_DOMAIN_NAME);
		...
		Element theReasonElm =
			EPPUtil.getElementByTagName(aElement, ELM_DOMAIN_REASON);
