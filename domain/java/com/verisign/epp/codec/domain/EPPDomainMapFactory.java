...
public class EPPDomainMapFactory extends EPPMapFactory {
	...
	public EPPCommand createCommand(Element aMapElement)
		...
		if (name.equals(EPPDomainCheckCmd.ELM_NAME)) {
			return new EPPDomainCheckCmd();
		}

		else if (name.equals(EPPDomainInfoCmd.ELM_NAME)) {
			return new EPPDomainInfoCmd();
		}
		else if (name.equals(EPPDomainCreateCmd.ELM_NAME)) {
			return new EPPDomainCreateCmd();
		}
		else if (name.equals(EPPDomainDeleteCmd.ELM_NAME)) {
			return new EPPDomainDeleteCmd();
		}
		else if (name.equals(EPPDomainRenewCmd.ELM_NAME)) {
			return new EPPDomainRenewCmd();
		}
		else if (name.equals(EPPDomainUpdateCmd.ELM_NAME)) {
			return new EPPDomainUpdateCmd();
		}
		else if (name.equals(EPPDomainTransferCmd.ELM_NAME)) {
	...
	public EPPResponse createResponse(Element aMapElement)
		...
		if (name.equals(EPPDomainCheckResp.ELM_NAME)) {
			return new EPPDomainCheckResp();
		}
		else if (name.equals(EPPDomainInfoResp.ELM_NAME)) {
			return new EPPDomainInfoResp();
		}
		else if (name.equals(EPPDomainCreateResp.ELM_NAME)) {
			return new EPPDomainCreateResp();
		}
		else if (name.equals(EPPDomainRenewResp.ELM_NAME)) {
			return new EPPDomainRenewResp();
		}
		else if (name.equals(EPPDomainTransferResp.ELM_NAME)) {
			return new EPPDomainTransferResp();
		}
		else if (name.equals(EPPDomainPendActionMsg.ELM_NAME)) {
			return new EPPDomainPendActionMsg();
		}
		else {
			throw new EPPCodecException("Invalid response type " + name);
		}
	}
