...
public class EPPHostAddress implements EPPCodecComponent {
	...
	// End EPPHostAddress.EPPHostAddress()
	...
	// EPPHostAddress.EPPHostAddress(String, int)
	 ...
	 */
	public EPPHostAddress(String aRootName, String aName) {
	 ...
	 * 		  <code>EPPHostAddress.IPV6</code> constant.
	 */
	public EPPHostAddress(String aRootName, String aName, short aType) {
		this.rootName     = aRootName;
		this.name		  = aName;
		this.type		  = aType;
	}
	...
	// End EPPHostAddress.getRootName()
	...
	// End EPPHostAddress.setRootName()
	...
	// End EPPHostAddress.setName(String)
	...
	// End EPPHostAddress.setName(String, short)
	...
	// End EPPHostAddress.setType(short)
	...
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		Element root = aDocument.createElement(this.rootName);
	...
	// End EPPHostAddress.encode(Document)
	...
	// End EPPHostAddress.decode(Element)
	...
	// End EPPHostAddress.equals(Object)
