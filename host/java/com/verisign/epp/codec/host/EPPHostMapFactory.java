...
public class EPPHostMapFactory extends EPPMapFactory {
	...
	public EPPCommand createCommand(Element aMapElement)
		...
		if (name.equals(EPPHostCheckCmd.ELM_NAME)) {
			return new EPPHostCheckCmd();
		}
		else if (name.equals(EPPHostInfoCmd.ELM_NAME)) {
			return new EPPHostInfoCmd();
		}
		else if (name.equals(EPPHostCreateCmd.ELM_NAME)) {
			return new EPPHostCreateCmd();
		}
		else if (name.equals(EPPHostDeleteCmd.ELM_NAME)) {
			return new EPPHostDeleteCmd();
		}
		else if (name.equals(EPPHostUpdateCmd.ELM_NAME)) {
	...
	public EPPResponse createResponse(Element aMapElement)
		...
		if (name.equals(EPPHostCheckResp.ELM_NAME)) {
			return new EPPHostCheckResp();
		}
		else if (name.equals(EPPHostInfoResp.ELM_NAME)) {
			return new EPPHostInfoResp();
		}
		else if (name.equals(EPPHostCreateResp.ELM_NAME)) {
			return new EPPHostCreateResp();
		}
		else if (name.equals(EPPHostPendActionMsg.ELM_NAME)) {
