...
public class NSDomain extends EPPDomain {
	 ...
	 * @deprecated Supports secDNS-1.0 and secDNS-1.1, but use the secDNS-1.1 method {@link #setSecDNSUpdate(List, List, boolean).
	 */
	 ...
	 *            request
	 * @deprecated Only supported with secDNS-1.0.  Look to use the secDNS-1.1 method {@link #setSecDNSUpdate(List, List, boolean).
	 */
