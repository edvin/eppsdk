...
public class EPPRgpExtReportText implements EPPCodecComponent {
    ...
    public Element encode(Document aDocument) throws EPPEncodeException {
        ...
        Element root = null;
        if (tagName == ELM_RES_REASON) {
            root = aDocument.createElementNS(EPPRgpExtFactory.NS, ELM_RES_REASON);
        }
        else if (tagName == ELM_STATEMENT) {
            root = aDocument.createElementNS(EPPRgpExtFactory.NS, ELM_STATEMENT);
        }
        else {
    ...
    /**
     * Get the current tag name.  "statement" or "reason"
     ...
     * @param tagName the new value of the tag name.
     */
