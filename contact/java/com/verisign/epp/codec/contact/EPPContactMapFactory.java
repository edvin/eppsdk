...
public class EPPContactMapFactory extends EPPMapFactory {
	...
	public EPPCommand createCommand(Element aMapElement)
		...
		if (name.equals(EPPContactCheckCmd.ELM_NAME)) {
			return new EPPContactCheckCmd();
		}
		else if (name.equals(EPPContactInfoCmd.ELM_NAME)) {
			return new EPPContactInfoCmd();
		}
		else if (name.equals(EPPContactCreateCmd.ELM_NAME)) {
			return new EPPContactCreateCmd();
		}
		else if (name.equals(EPPContactDeleteCmd.ELM_NAME)) {
			return new EPPContactDeleteCmd();
		}
		else if (name.equals(EPPContactUpdateCmd.ELM_NAME)) {
			return new EPPContactUpdateCmd();
		}
		else if (name.equals(EPPContactTransferCmd.ELM_NAME)) {
	...
	public EPPResponse createResponse(Element aMapElement)
		...
		if (name.equals(EPPContactCheckResp.ELM_NAME)) {
			return new EPPContactCheckResp();
		}
		else if (name.equals(EPPContactInfoResp.ELM_NAME)) {
			return new EPPContactInfoResp();
		}
		else if (name.equals(EPPContactTransferResp.ELM_NAME)) {
			return new EPPContactTransferResp();
		}
		else if (name.equals(EPPContactCreateResp.ELM_NAME)) {
			return new EPPContactCreateResp();
		}
		else if (name.equals(EPPContactPendActionMsg.ELM_NAME)) {
