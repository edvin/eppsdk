...
public class EPPContactCreateCmd extends EPPCreateCmd {
	...
	public EPPContactCreateCmd(
		...
		email		 = aEmail;
		authInfo     = aAuthInfo;
		authInfo.setRootName(EPPContactMapFactory.ELM_CONTACT_AUTHINFO);
	}
	...
	protected void doDecode(Element aElement) throws EPPDecodeException {
		...
		// voiceExt
		if (voice != null) {
			currElm = EPPUtil.getElementByTagName(aElement, ELM_CONTACT_VOICE);
		...
		// faxExt
		if (fax != null) {
			currElm     = EPPUtil.getElementByTagName(
													  aElement, ELM_CONTACT_FAX);
