...
public class EPPNamestoreExtNamestoreExt implements EPPCodecComponent {
	...
	public static final String ELM_NAME = "namestoreExt:namestoreExt";

	/** XML tag name for the <code>_subProductID</code> attribute. */
	private static final String ELM_SUB_PRODUCT_ID = "namestoreExt:subProduct";
	 ...
	 * sub-product identifier.
	 *
	 * @param aSubProductID Sub-product identifier
	 */
	 ...
	 *
	 * @param aSubProductID Registry Identifier
	 */
	 ...
	 * 			  <code>EPPNamestoreExtNamestoreExt</code>
	 */
	public Element encode(Document aDocument) throws EPPEncodeException {
		// Validate state
		if (_subProductID == null) {
			throw new EPPEncodeException("subProductID required attribute is not set");
		}
	...
	public void decode(Element aElement) throws EPPDecodeException {
		...
		_subProductID =
			EPPUtil.decodeString(
								 aElement, EPPNamestoreExtExtFactory.NS,
								 ELM_SUB_PRODUCT_ID);
	}
	...
	public Object clone() throws CloneNotSupportedException {
		EPPNamestoreExtNamestoreExt clone =
			(EPPNamestoreExtNamestoreExt) super.clone();
	...
	/**
	 * Compare an instance of <code>EPPNamestoreExtNamestoreExt</code> with
	 * this instance.
	 *
	...
	public boolean equals(Object aObject) {
		...
		EPPNamestoreExtNamestoreExt theComp =
			(EPPNamestoreExtNamestoreExt) aObject;

		if (
			!(
					(_subProductID == null) ? (theComp._subProductID == null)
