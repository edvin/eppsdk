 ...
 *
 * @author clloyd
 * @version 1.0 EPPSchemaCachingParser is a DocumentBuilder implementation that caches schemas when peforming schema validation. <p><p>
 */
public class EPPSchemaCachingParser extends DocumentBuilder
	...
	private static Logger cat =
		Logger.getLogger(
						 EPPSchemaCachingParser.class.getName(),
						 EPPCatFactory.getInstance().getFactory());

	/**
	 * A default prime number to use for the SymbolTable size. Some other
	 * sample big primes: 1299709 1299721 1299743 1299763 1299791 1299811
     ...
     * full schema grammar constraint checking, including checking
	 ...
	 * The recommendation is to set this to false for EPP packets since
	 * the are not large documents.
	 */
	...
	/**
	 * Create a new instance of EPPSchemaCachingParser.  Defaults are:
	 * Namespace aware: true Validation: true Schema Validation: true Full
	 * Schema checking: true
	 */
	...
	/**
	 * Creates an EPPSchemaCachingParser instance with the specified
	 * symboltable size
	 *
	 ...
	 *
	 * @throws EPPParserException DOCUMENT ME!
	 */
	 ...
	 *
	 * @param aBoolean True param locks it, false unlocks it
	 */
	 ...
	 *
	 * @param aSchema The schema instance to be cached
	 *
	 * @throws EPPParserException DOCUMENT ME!
	 */
	public void addSchemaToCache(XMLInputSource aSchema)
		...
		XMLGrammarPreparser preparser =
			new XMLGrammarPreparser(preparserSymTable);
		...
		try {
			...
			/**
			 * @todo Revisit how to not add schemas that are already in the
			 * 		 pool - Warnings come up when with
			...
			//            GrammarPool domParsersGrammarPool = parserImpl.getProperty(XMLGRAMMAR_POOL);
	 ...
	 *
	 * @param aEntityResolver The EntityResolver instance that this
	 * 		  DocumentBuilder will use when parsing.
	 */
	 ...
	 *
	 * @param aXmlInstance The XML instance to parse
	 *
	 * @return The DOM Document that represents the XML instance
	 *
	 * @throws org.xml.sax.SAXException Thrown if any errors occur
	 * @throws java.io.IOException Thrown if any errors occur
	 ...
	 * DOMParser
	 *
	 * @param aInputStream The InputStream instance to parse
	 * @param aSystemId
	 *
	 ...
	 *
	 * @param aErrorHandler The ErrorHandler instance to use
	 */
	 ...
	 *
	 * @param aSymbolTableSize The new value of the symbol table size
	 *
	 * @throws EPPParserException DOCUMENT ME!
	 */
	 ...
	 * recognize the feature, and if it does recognize it, it might not be
	 * able to fulfill the request.
	 *
	 * @param aFeatureId The unique identifier (URI) of the feature.
	 * @param aBoolean The requested state of the feature (true or false).
	 *
	 * @exception SAXNotSupportedException If the requested feature is known,
	 ...
	 * able to fulfill the request.
	 *
	 * @param aProperty The unique identifier (URI) of the feature.
	 * @param aObject The requested state of the feature (true or false).
	 *
	 * @exception SAXNotSupportedException If the requested feature is known,
	 * 			  but the requested state is not supported.
	 * @exception SAXNotRecognizedException If the requested feature is not
	...
	/**
	 * Query the state of a feature. Query the current state of any feature in
	 * a SAX2 parser.  The parser might not recognize the feature.
	 *
	 * @param aFeatureId The unique identifier (URI) of the feature being set.
	 *
	 ...
	 *
	 * @param aPropertyId The unique identifier (URI) of the property being
	 * 		  set.
	 *
