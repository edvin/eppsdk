...
public class EPPApplication {
	...
	private void initParserPool() {
		...
		if (!_parserInitialized) {
			...
			meta.setInitialObjects(EPPEnv.getClientParserInitObjs());
			meta.setMinimumSize(EPPEnv.getClientParserMinSize());
			meta.setMaximumSize(EPPEnv.getClientParserMaxSize());
			meta.setMaximumSoft(EPPEnv.getClientParserMaxSoft());
			meta.setObjectTimeout(EPPEnv.getClientParserObjTimeout());
			meta.setUserTimeout(EPPEnv.getClientParserUserTimeout());
			meta.setSkimmerFrequency(EPPEnv.getClientParserSkimmerFreq());
			meta.setShrinkBy(EPPEnv.getClientParserShrinkBy());
			meta.setLogFile(EPPEnv.getClientParserLogFile());
			meta.setDebugging(EPPEnv.getClientParserDebug());
            ...
            // set any specific parser properties
