...
public class EPPStatement implements EPPCodecComponent {
	...
	static {
		...
		retentionElmHash.put(
							 ELM_RETENTION_BUSINESS,
							 new Short(RETENTION_BUSINESS));
		retentionElmHash.put(
							 ELM_RETENTION_INDEFINITE,
							 new Short(RETENTION_INDEFINITE));
		retentionElmHash.put(ELM_RETENTION_LEGAL, new Short(RETENTION_LEGAL));
		retentionElmHash.put(ELM_RETENTION_NONE, new Short(RETENTION_NONE));
		retentionElmHash.put(ELM_RETENTION_STATED, new Short(RETENTION_STATED));
	}
	...
	public void decode(Element aElement) throws EPPDecodeException {
		...
		// Retention
		theElm = EPPUtil.getElementByTagName(aElement, ELM_RETENTION);
		...
		Short theRetentionValue =
			(Short) retentionElmHash.get(theRetentionValueElm.getNodeName());
