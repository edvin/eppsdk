...
public class EPPDcp implements EPPCodecComponent {
	...
	static {
		...
		accessElmHash.put(ELM_ACCESS_ALL, new Short(ACCESS_ALL));
		accessElmHash.put(ELM_ACCESS_NONE, new Short(ACCESS_NONE));
		accessElmHash.put(ELM_ACCESS_NULL, new Short(ACCESS_NULL));
		accessElmHash.put(ELM_ACCESS_PERSONAL, new Short(ACCESS_PERSONAL));
		accessElmHash.put(
						  ELM_ACCESS_PERSONAL_AND_OTHER,
						  new Short(ACCESS_PERSONAL_AND_OTHER));
		accessElmHash.put(ELM_ACCESS_OTHER, new Short(ACCESS_OTHER));
	}
	...
	public void decode(Element aElement) throws EPPDecodeException {
		...
		// Access
		theElm = EPPUtil.getElementByTagName(aElement, ELM_ACCESS);
		...
		Short theAccessValue =
			(Short) accessElmHash.get(theAccessValueElm.getNodeName());
		...
		Element theExpiryElm =
			EPPUtil.getElementByTagName(aElement, ELM_EXPIRY);

		if (theExpiryElm != null) {
			Element theExpiryValue =
				EPPUtil.getElementByTagName(theExpiryElm, ELM_EXPIRY_ABSOLUTE);
