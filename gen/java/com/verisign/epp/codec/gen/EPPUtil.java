...
public class EPPUtil {
	...
	/**
	 * Format used for the XML Schema timeInstant data type without
	 * milliseconds.
	 */
	...
	private static Logger cat = Logger.getLogger(EPPUtil.class.getName(), EPPCatFactory
	...
	static {
		// Pre-compile the timeinstant regular expression
		timeInstantPattern = Pattern
				.compile("\\d{4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{1,2}:\\d{1,2}(\\.\\d{1,4})?Z");
	}

	/**
	 * Appends the children Nodes of <code>aSource</code> as children nodes of
	 * <code>aDest</code>.
	 * @param aSource Source Element tree to get children from
	 * @param aDest Destination Element to append <code>aSource</code>
	 *            children.
	 */
	 ...
	 * returned.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &ltdomain:create&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @return <code>BigDecimal</code> value if found; <code>null</code>
	 *         otherwise.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static BigDecimal decodeBigDecimal(Element aElement, String aNS,
			String aTagName) throws EPPDecodeException {

		Element theElm = EPPUtil.getElementByTagName(aElement, aTagName);
		...
		if (theElm != null) {
			...
			if (textNode != null) {
				...
				try {
					...
					throw new EPPDecodeException("Can't convert value to Double: "
							+ doubleValStr + e);
				}
			} else {
	...
	/**
	 * Decode <code>Boolean</code>, by XML namespace and tag name, from an
	 * XML Element. The children elements of <code>aElement</code> will be
	 * searched for the specified <code>aNS</code> namespace URI and the
	 * specified <code>aTagName</code>. The first XML element found will be
	 * decoded and returned. If no element is found, <code>null</code> is
	 ...
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @return <code>Boolean</code> value if found; <code>null</code>
	 *         otherwise.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static Boolean decodeBoolean(Element aElement, String aNS, String aTagName)
	 ...
	 * attribute name.
	 * @param aElement Element with the attribute to look for
	 * @param aAttr Attribute name
	 * @return Decoded boolean value
	 * @exception EPPDecodeException Cound not find attribute or the attribute
	...
	/**
	 * Decode a <code>EPPCodecComponent</code>, by XML namespace and tag
	 * name, from an XML Element. The children elements of <code>aElement</code>
	 * will be searched for the specified <code>aNS</code> namespace URI and
	 * the specified <code>aTagName</code>. There first XML element found
	 * will be used to initial and instance of <code>aClass</code>.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &ltdomain:update&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 ...
	 *            is "domain:server".
	 * @param aClass Class to instantiate for a found XML element. This must be
	...
	/**
	 * Decode a <code>List</code> of <code>EPPCodecComponent</code>'s, by
	 * XML namespace and tag name, from an XML Element. The children elements of
	 * <code>aElement</code> will be searched for the specified
	 * <code>aNS</code> namespace URI and the specified <code>aTagName</code>.
	 * Each XML element found will result in the instantiation of
	 * <code>aClass</code>, which will decode the associated XML element and
	 ...
	 * @param aClass Class to instantiate for each found XML element. This must
	 *            be a class that implements <code>EPPCodecComponent</code>
	 * @return <code>List</code> of <code>EPPCodecComponent</code> elements
	 *         representing the found XML elements.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static List decodeCompList(Element aElement, String aNS, String aTagName,
			Class aClass) throws EPPDecodeException {
		List retVal = new ArrayList();

		try {
			Vector theChildren = EPPUtil.getElementsByTagName(aElement, aTagName);
	...
	/**
	 * Decode a <code>Vector</code> of <code>EPPCodecComponent</code>'s, by
	 * XML namespace and tag name, from an XML Element. The children elements of
	 * <code>aElement</code> will be searched for the specified
	 * <code>aNS</code> namespace URI and the specified <code>aTagName</code>.
	 * Each XML element found will result in the instantiation of
	 * <code>aClass</code>, which will decode the associated XML element and
	 * added to the returned <code>Vector</code>.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &ltdomain:add&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 ...
	 * @param aClass Class to instantiate for each found XML element. This must
	 *            be a class that implements <code>EPPCodecComponent</code>
	 * @return <code>Vector</code> of <code>EPPCodecComponent</code>
	 *         elements representing the found XML elements.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	 ...
	 * Element. The children elements of <code>aElement</code> will be
	 * searched for the specified <code>aNS</code> namespace URI and the
	 * specified <code>aTagName</code>. The first XML element found will be
	 * decoded and returned. If no element is found, <code>null</code> is
	 * returned. The format used for decoding the date is defined by the
	 * constant <code>EPPUtil.DATE_FORMAT</code>.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &lttrans-id&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 ...
	 *            is "date".
	 * @return <code>Date</code> value if found; <code>null</code>
	 *         otherwise.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	 ...
	 * @param aDateValue XML Schema date data type string (YYYY-MM-DD).
	...
	/**
	 * Decode <code>Integer</code>, by XML namespace and tag name, from an
	 * XML Element. The children elements of <code>aElement</code> will be
	 * searched for the specified <code>aNS</code> namespace URI and the
	 * specified <code>aTagName</code>. The first XML element found will be
	 * decoded and returned. If no element is found, <code>null</code> is
	 ...
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @return <code>Integer</code> value if found; <code>null</code>
	 *         otherwise.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static Integer decodeInteger(Element aElement, String aNS, String aTagName)
			throws EPPDecodeException {
		...
		if (theElm != null) {
			...
			if (textNode != null) {
				...
				try {
					...
					throw new EPPDecodeException("Can't convert value to Integer: "
							+ intValStr + e);
				}
			} else {
				throw new EPPDecodeException(
	...
	/**
	 * Decode a <code>List</code> of <code>String</code>'s by XML namespace
	 * and tag name, from an XML Element. The children elements of
	 * <code>aElement</code> will be searched for the specified
	 * <code>aNS</code> namespace URI and the specified <code>aTagName</code>.
	 * Each XML element found will be decoded and added to the returned
	 * <code>List</code>. Empty child elements, will result in empty string
	 * ("") return <code>List</code> elements.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &ltdomain:update&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 ...
	 *            prefix. For example, the tag name for the domain name servers
	 *            is "domain:server".
	 * @return <code>List</code> of <code>String</code> elements
	 *         representing the text nodes of the found XML elements.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	 ...
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @return <code>String</code> value if found; <code>null</code>
	 *         otherwise.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static String decodeString(Element aElement, String aNS, String aTagName)
			throws EPPDecodeException {
		String retVal = null;
	 ...
	 * name, from an XML Element. The children elements of <code>aElement</code>
	 * will be searched for the specified <code>aNS</code> namespace URI and
	 * the specified <code>aTagName</code>. The first XML element found will
	 * be decoded and returned. If no element is found, <code>null</code> is
	 * returned. The format used for decoding the date is defined by the
	 ...
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static Date decodeTimeInstant(Element aElement, String aNS, String aTagName)
			throws EPPDecodeException {
		Date retVal = null;
	...
	/**
	 * Decode an XML Schema timeInstant data type to a Java Date object. The XML
	 * Schema timeInstant data type string has the following format:
	 * CCYY-MM-DDThh:mm:ss.ssss can be followed by a Z to indicate Coordinated
	 * Universal Time
	 * @param aTimeInstant XML Schema timeInstant data type string.
	 * @return Java Date object if <code>aTimeInstant</code> format is valid;<code>null</code>
	 *         otherwise
	 */
	public static Date decodeTimeInstant(String aTimeInstant) {

		Date theRetDate = null;

		Matcher theMatcher = timeInstantPattern.matcher(aTimeInstant);

		// Is the aTimeInstance a valid format?
		if (theMatcher.matches()) {
			TimeZone theUtcTimeZone = TimeZone.getTimeZone("UTC");
			SimpleDateFormat theFormatter;

			// Milliseconds specified?
			if (theMatcher.group(1) != null) {
				theFormatter = new SimpleDateFormat(TIME_INSTANT_FORMAT);
			} else {
				theFormatter = new SimpleDateFormat(TIME_INSTANT_NO_MILLI_FORMAT);
			}

			theFormatter.setTimeZone(theUtcTimeZone);
			theRetDate = theFormatter.parse(aTimeInstant, new ParsePosition(0));
		}
	...
	/**
	 * Decode a <code>Vector</code> of <code>String</code>'s by XML
	 * namespace and tag name, from an XML Element. The children elements of
	 * <code>aElement</code> will be searched for the specified
	 * <code>aNS</code> namespace URI and the specified <code>aTagName</code>.
	 * Each XML element found will be decoded and added to the returned
	 * <code>Vector</code>. Empty child elements, will result in empty string
	 * ("") return <code>Vector</code> elements.
	 * @param aElement XML Element to scan. For example, the element could be
	 *            &ltdomain:update&gt
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 ...
	 *            prefix. For example, the tag name for the domain name servers
	 *            is "domain:server".
	 * @return <code>Vector</code> of <code>String</code> elements
	 *         representing the text nodes of the found XML elements.
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static Vector decodeVector(Element aElement, String aNS, String aTagName)
			throws EPPDecodeException {
		Vector retVal = new Vector();
	 ...
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aBigDecimal <code>Double</code> to add.
	 * @param aNS XML namespace of the element. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @exception EPPEncodeException Error encoding the <code>Double</code>.
	 */
	 ...
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aBoolean <code>Boolean</code> to add.
	 * @param aNS XML namespace of the element. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @exception EPPEncodeException Error encoding the <code>Boolean</code>.
	 */
	public static void encodeBoolean(Document aDocument, Element aRoot,
			Boolean aBoolean, String aNS, String aTagName) throws EPPEncodeException {
		if (aBoolean != null) {
	...
	/**
	 * Encodes a boolean <code>Element</code> attribute value. The attribute
	 * is set to &quot;1&quot; with a value of <code>true</code> and is set to
	 * &quot;0&quot; with a value of <code>false</code>.
	 * @param aElement Element to add attribute to
	 * @param aAttr Attribute name
	 * @param aVal Attribute boolean value
	 */
	...
	/**
	 * Encode a <code>EPPCodecComponent</code> instance in XML. The component
	 * is first checked for not being <code>null</code>, than it will be
	 * appended as a child of <code>aRoot</code>.
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add to. For example, the root node could be
	 *            &ltdomain:update&gt
	 * @param aComp <code>EPPCodecComponent's</code> to add.
	...
	/**
	 * Encode a <code>List</code> of <code>EPPCodecComponent</code>'s in
	 * XML. Each <code>aList</code> element will be encoded and added to
	 * <code>aRoot</code>.
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aList <code>List</code> of <code>EPPCodecComponent's</code> to
	 *            add.
	 * @exception EPPEncodeException Error encoding the <code>List</code> of
	 *                <code>EPPCodecComponent</code>'s.
	 */
	public static void encodeCompList(Document aDocument, Element aRoot, List aList)
			throws EPPEncodeException {
		if (aList != null) {
	...
	/**
	 * Encode a <code>Vector</code> of <code>EPPCodecComponent</code>'s in
	 * XML. Each <code>aVector</code> element will be encoded and added to
	 * <code>aRoot</code>.
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aVector <code>Vector</code> of <code>EPPCodecComponent's</code>
	 *            to add.
	 * @exception EPPEncodeException Error encoding the <code>Vector</code> of
	 *                <code>EPPCodecComponent</code>'s.
	 */
	 ...
	 * @param aDate Java Date to encode into a XML Schema date data type string.
	 ...
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aDate <code>Date</code> to add.
	 * @param aNS XML namespace of the element. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @exception EPPEncodeException Error encoding <code>Date</code>.
	 */
	...
	/**
	 * Encode a <code>List</code> of <code>String</code>'s in XML with a
	 * given XML namespace and tag name.
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aList <code>List</code> of <code>String's</code> to add.
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name servers
	 ...
	 *                <code>String</code>'s.
	 */
	public static void encodeList(Document aDocument, Element aRoot, List aList,
			String aNS, String aTagName) throws EPPEncodeException {
		Element currElm;
		Text currVal;
	 ...
	 * @param aRoot DOCUMENT ME!
	 * @param aNS DOCUMENT ME!
	 * @param aTagName DOCUMENT ME!
	 * @throws EPPEncodeException DOCUMENT ME!
	 */
	public static void encodeNill(Document aDocument, Element aRoot, String aNS,
	 ...
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aString <code>String</code> to add.
	 * @param aNS XML namespace of the element. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name is
	 *            "domain:name".
	 * @exception EPPEncodeException Error encoding the <code>String</code>.
	 */
	public static void encodeString(Document aDocument, Element aRoot, String aString,
			String aNS, String aTagName) throws EPPEncodeException {
		if (aString != null) {
			Element currElm = aDocument.createElementNS(aNS, aTagName);
	...
	public static void encodeStringList(Document aDocument, Element aRoot, List aList,
			String aNS, String aTagName) {
		String aString;
		Element aElement;
		Text aValue;
	 ...
	 * CCYY-MM-DDThh:mm:ss.ssss can be followed by a Z to indicate Coordinated
	 * Universal Time
	 * @param aDate Java Date to encode into a XML Schema timeInstant data type
	 *            string.
	 ...
	 * @param aDate <code>Date</code> as date and time to add.
	 * @param aNS XML namespace of the element. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 ...
	 * @exception EPPEncodeException Error encoding <code>Date</code>.
	 */
	public static void encodeTimeInstant(Document aDocument, Element aRoot, Date aDate,
			String aNS, String aTagName) throws EPPEncodeException {
		if (aDate != null) {
			encodeString(aDocument, aRoot, EPPUtil.encodeTimeInstant(aDate), aNS,
					aTagName);
		}
	}

	/**
	 * Encode a <code>Vector</code> of <code>String</code>'s in XML with a
	 * given XML namespace and tag name.
	 * @param aDocument DOM Document of <code>aRoot</code>. This parameter
	 *            also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to. For example, the root
	 *            node could be &ltdomain:update&gt
	 * @param aVector <code>Vector</code> of <code>String's</code> to add.
	 * @param aNS XML namespace of the elements. For example, for domain element
	 *            this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 *            prefix. For example, the tag name for the domain name servers
	 ...
	 *                <code>String</code>'s.
	 */
	public static void encodeVector(Document aDocument, Element aRoot, Vector aVector,
			String aNS, String aTagName) throws EPPEncodeException {
		Element currElm;
		Text currVal;
	...
	/**
	 * compares two <code>List</code> instances. The Java 1.1
	 * <code>List</code> class does not implement the <code>equals</code>
	 * methods, so <code>equalLists</code> was written to implement
	 * <code>equals</code> of two <code>Lists</code> (aV1 and aV2). This
	 * method is not need for Java 2.
	 * @param aV1 First List instance to compare.
	 * @param aV2 Second List instance to compare.
	 ...
	 * method is not need for Java 2.
	 * @param aV1 First Vector instance to compare.
	 * @param aV2 Second Vector instance to compare.
	...
	/**
	 * Gets the first direct child element with a given tag name. The standard
	 * Element.getElementsByTagName does a tree search for all decendent child.
	 * @param aElement Element to scan from
	 * @param aTagName Tag name to scan for.
	 * @return Matching <code>Element</code> if found; <code>null</code>
	 *         otherwise.
	 */
	public static Element getElementByTagName(Element aElement, String aTagName) {
		...
		for (int i = 0; i < theChildren.getLength(); i++) {
			if (theChildren.item(i).getNodeType() == Node.ELEMENT_NODE) {
				Element currElement = (Element) theChildren.item(i);

				if (currElement.getTagName().equals(aTagName)) {
					return currElement;
				}
			}
		}
	...
	// End EPPUtil.appendChildren(Element, Element)

	/**
	 * Gets all of the direct child element with a given tag name. The standard
	 * Element.getElementsByTagName does a tree search for all decendent child.
	 * @param aElement Element to scan from
	 * @param aTagName Tag name to scan for.
	 * @return <code>Vector</code> of <code>Node</code> instances that are
	 *         elements and have the specified tag name.
	 */
	public static Vector getElementsByTagName(Element aElement, String aTagName) {
		Vector retVal = new Vector();
		NodeList theChildren = aElement.getChildNodes();
	...
	// End EPPUtil.toString(EPPCodecComponent)

	/**
	 * Gets the first DOM Element Node of the <code>aElement</code> DOM
	 * Element.
	 * @param aElement Element to scan for the first element.
	...
	// End EPPUtil.getElementsByTagName(Element, String)

	/**
	 * Gets the next sibling Element of a provided Element.
	 * @param aElement Element to start scan for the next Element.
	 * @return Found DOM Element Node if found; <code>null</code> otherwise.
	 */
	 ...
	 * <code>false</code>.
	 * @param aV1 Subset <code>List</code> to compare against <code>aV2</code>
	 * @param aV2 Superset <code>List</code> to compare against
	 *            <code>aV1</code>
	...
	/**
	 * Converts an <code>EPPCodecComponent</code> to a <code>String</code>
	 * for printing. Each <code>EPPCodecComponent</code> can use this utility
	 * method to implement <code>Object.toString()</code>.
	 * @param aComponent a concrete <code>EPPCodecComponent</code> instance
	...
	public static String toString(EPPCodecComponent aComponent) {
		...
		try {
			...
			// Create byte stream to hold result of XML serialization
			CharArrayWriter stream = new CharArrayWriter();

			// Set the XML formatting to indent and to omit the XML declaration
			OutputFormat format = new OutputFormat();
			format.setIndenting(true);
			format.setOmitXMLDeclaration(true);

			// Write encoded component to stream
			XMLSerializer serializer = new XMLSerializer(stream, format);
			serializer.serialize(aComponent.encode(document));

			// Set String with encoded stream
			ret = stream.toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * <code>aV2</code> return <code>true</code>; otherwise return
	 * <code>false</code>.
	 * @param aV1 Subset <code>Vector</code> to compare against
	 *            <code>aV2</code>
	 * @param aV2 Superset <code>Vector</code> to compare against
	 *            <code>aV1</code>
	 * @return <code>true</code> if <code>aV1</code> is a subset of
	 *         <code>aV2</code>; <code>false</code> otherwise.
	 */
	...
	/**
	 * Decode a <code>List</code> of <code>Integer</code>'s by XML namespace
	 * and tag name, from an XML Element.  The children elements of
	 * <code>aElement</code> will be searched for the specified
	 * <code>aNS</code> namespace URI and the specified <code>aTagName</code>.
	 * Each XML element found will be decoded and added to the returned
	 * <code>List</code>. Empty child elements, will result in an <code>EPPDecodeException</code>.
	 *
	 * @param aElement XML Element to scan.  For example, the element could be
	 * 		  &ltdomain:update&gt
	 * @param aNS XML namespace of the elements.  For example, for domain
	 * 		  element this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 * 		  prefix.  For example, the tag name for the domain name servers
	 * 		  is "domain:server".
	 *
	 ...
	 * @exception EPPDecodeException Error decoding <code>aElement</code>.
	 */
	public static List decodeIntegerList(
			  Element aElement, String aNS,
			  String aTagName)
	   throws EPPDecodeException {
	...
	/**
	 * Encode a <code>List</code> of <code>Integer</code>'s in XML with a
	 * given XML namespace and tag name.
	 *
	 * @param aDocument DOM Document of <code>aRoot</code>.  This parameter
	 * 		  also acts as a factory for XML elements.
	 * @param aRoot XML Element to add children nodes to.  For example, the
	 * 		  root node could be &ltdomain:update&gt
	 * @param aList <code>List</code> of <code>Integer</code>'s to add.
	 * @param aNS XML namespace of the elements.  For example, for domain
	 * 		  element this is "urn:iana:xmlns:domain".
	 * @param aTagName Tag name of the element including an optional namespace
	 * 		  prefix.  For example, the tag name for the domain name servers
	 ...
	 * 			  <code>Integer</code>'s.
	 */
	public static void encodeIntegerList(
									Document aDocument, Element aRoot,
		...
		if (aList != null) {
			...
			while (elms.hasNext()) {
				currElm     = aDocument.createElementNS(aNS, aTagName);
				currVal =
					aDocument.createTextNode(elms.next().toString());
	...
	/**
	 * Collapse Whitespace, which means that all leading and trailing whitespace will be stripped, 
	 * and all internal whitespace collapsed to single space characters.
	 * Intended to emulate XML Schema whitespace (collapse) constraining facet:
	 * http://www.w3.org/TR/xmlschema-2/#rf-whiteSpace
	 * 
	 * @param inString <code>String</code> to be collapsed
	 * @return <code>String</code> with whitespace collapsed, or null when result is empty
	 */
		...
		for (int i = 0; i < len; i++) {
			...
			if (Character.isWhitespace(c) == false) {
				...
				if (prevWhitespace == false) {
					sb.append(' '); // replace each sequence of whitespace with a single space
					prevWhitespace = true;
				}
			}
		}
	 ...
	 * 
	 * @param inString <code>String</code> from which to remove whitespace
	 * @return <code>String</code> with whitespace removed, or null when result is empty
	 */
