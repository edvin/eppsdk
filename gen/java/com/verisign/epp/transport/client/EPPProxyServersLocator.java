...
public interface EPPProxyServersLocator {
	...
	/**
	 * Returns a <code>List</code> of {@link EPPProxyServers} instances for 
	 ...
	 * 
	 * @return List of {@link EPPProxyServers} servers in the correct format if defined;<code>null</code>
	 *         otherwise.
	 */
