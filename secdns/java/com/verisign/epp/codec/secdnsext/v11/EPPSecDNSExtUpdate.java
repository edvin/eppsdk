...
public class EPPSecDNSExtUpdate implements EPPCodecComponent {
	...
	public void decode(Element aElement) throws EPPDecodeException {
		...
		Element remElm = EPPUtil.getElementByTagName(aElement, ELM_REM);
		...
		Element addElm = EPPUtil.getElementByTagName(aElement, ELM_ADD);
		...
		Element chgElm = EPPUtil.getElementByTagName(aElement, ELM_CHG);
		if (chgElm != null) {
